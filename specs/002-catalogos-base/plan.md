# Implementation Plan: Sprint 02 - Catálogos base
...
Provide global chart seed, user-owned accounts, guided account creation, basic Entidades and simple tags.
...
- **MVP Scope & Sprint Fit**: PASS — design artifacts remain scoped to `Sprint 02 - Catálogos base`.
